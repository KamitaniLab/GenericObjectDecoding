function images = downloadimages_ImageNet(username, accessKey)
% downloadimages_ImageNet    Get images from ImageNet
%
...
% For debugging
%imageListFiles = {'./data/images/image_training_id_debug.csv', ...
%                  './data/images/image_test_id_debug.csv'};

% Type of images ('training' or 'test')
% This should corresponde to 'imageListFiles'
imageType = {'training', ...
             'test'};
